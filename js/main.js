...
addStudent(){
    let name = prompt("Enter student full name:", "Aric Masih");
    let email = prompt("Enter student email:", "masiharic@seattleu.edu");
    let newStudent = new Student(name, email);
    this.students.push(newStudent);
    updateRoster(this);
}
setTeacher(){
    let name = prompt("Enter full teacher name:","Bruce Banner");
    let email = prompt("Enter teacher email:", "brucebanner@seattleu.edu");
...
let courseDescription = prompt("Enter course description:", "Learning JavaScript");
